...
(deftest apply-covers-any-arity
  (testing "apply works past the fixed direct-call ceiling"
    (is (= {:length 5} (q/dims (apply u/meter [2 2 2 2 2])))))
  (testing "a direct call past the ceiling fails (apply is the escape hatch)"
    (is (thrown? Throwable (u/meter 1 2 3 4 5 6 7 8 9)))))   ; > 8 args: no invoke arity
